...
module map_functions
    ...
    function compute_map_and_propagator(MPS_vec,layout,δt;kwargs...)
        ...
        Λs = [calculateDynamicalMap(MPS_vec[1],layout,ordering_choice), 
                calculateDynamicalMap(MPS_vec[2],layout,ordering_choice),
                calculateDynamicalMap(MPS_vec[3],layout,ordering_choice)]
